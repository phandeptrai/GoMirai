...
import com.gomirai.ride.booking.dto.external.RefundRequest;
...
public class PaymentServiceClient {
    ...
    @Bulkhead(name = "paymentWallet", fallbackMethod = "payRideBulkheadFallback")
     ...
     */
    public TransactionResponse payRideBulkheadFallback(RidePaymentRequest request, Throwable t) {
        log.warn("SLA_BULKHEAD_REJECT paymentWallet payRide: {}", t.toString());
        throw new BusinessException("PAYMENT_OVERLOADED: Payment path saturated — try again shortly");
    }
    ...
    @Bulkhead(name = "paymentWallet", fallbackMethod = "refundBulkheadFallback")
    ...
    public TransactionResponse refundBulkheadFallback(RefundRequest request, Throwable t) {
        log.warn("SLA_BULKHEAD_REJECT paymentWallet refund: {}", t.toString());
        throw new BusinessException("PAYMENT_OVERLOADED: Refund path saturated — try again shortly");
    }
    ...
    private ServiceInstance getServiceInstance() {
        try {
            ...
            log.info("Selected PaymentService instance (Round Robin): {}:{} (Index: {})", 
